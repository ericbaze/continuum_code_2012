...
function easywp_init(){
	...
	if(isset($_GET['toggleView']) && $user_level == '10'){
		if($view == 'false'){
...
function easywp_setbutton($adminviewtext, $adminviewclass){
	...
	if($view == 'false' || $user_level != '10'){
		echo '<div id="easy-wp-logo"><a href="'.get_site_url().'"><img src="'.plugins_url().'/easy-wp/img/logo.png" title="Powered by Wordpress" width="140px"></a></div>';
	}
...
function easywp_setui($pages, $plugins){?>
	...
	<div id="bigmenutitle">
		<?php _e('Your <strong>pages</strong>', 'easy-wp');?>
	</div>
	<div id="newmenu">
	...
	<div id="secondarymenutitle">
		<?php _e('Your <strong>plugins</strong>', 'easy-wp');?>
