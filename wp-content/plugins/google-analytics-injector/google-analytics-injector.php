...
function inject_google_analytics_code() {
  if (!is_admin() && get_option('ua_tracking_code') != "") {
    echo "<!-- Google Analytics Injector 1.1 from http://www.geckosolutions.se/blog/wordpress-plugins/ -->\n"; 
    echo get_google_analytics_tracking_code(get_option('ua_tracking_code'), get_option('site_restriction_url'));
 ...
 */
function get_google_analytics_tracking_code($ua_tracking_code, $site_restriction_url) {
